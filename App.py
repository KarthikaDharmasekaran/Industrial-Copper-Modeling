...
with tab1:    
        ...
        if submit_button and flag==0:
            ...
            import pickle
            with open(r"C:\\Users\\USER\Desktop\\code\\cmodel.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'C:\\Users\\USER\\Desktop\\code\\scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"C:\\Users\\USER\\Desktop\\code\\t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"C:\\Users\\USER\\Desktop\\code\\s.pkl", 'rb') as f:
                s_loaded = pickle.load
            ...
            new_sample_ohe = t_loaded.transform(new_sample[:, [7,3]]).toarray()
            new_sample_be = s_loaded.transform(new_sample[:, [8,5]]).toarray()
...
with tab2: 
        ...
        if csubmit_button and cflag==0:
            ...
            with open(r'C:\\Users\\USER\\Desktop\\code\\cscaler.pkl', 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"C:\\Users\\USER\\Desktop\\code\\ct.pkl", 'rb') as f:
...
st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by D.karthika</h6>', unsafe_allow_html=True )  
